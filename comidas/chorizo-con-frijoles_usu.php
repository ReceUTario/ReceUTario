...
<HTML lang = "es-MX" >
<HEAD>
    <title>Chorizo con frijoles</title>
...
<body>  
      ...
      <div class="jumbotron mt-4 marg-1">
                    <hr>
                     <h1 class="text-center roboto">Corizo con frijoles.</h1>
               <hr>
            <div class="container text-center"> 
                <img src="../img/comida15.jpg" alt="Chorizo con frijol"  class="img-fluid border border-prymari" >
            </div>
               <hr>  
    <div class="container-fluid text-center">
        <h2>Ingredientes</h2>
        
           <h6> 1 litro frijoles </h6>
            <h6> 200 gr chorizo casero o el que gusten </h6>
                <h6> 1 cucharada ajo sazonado en aceite </h6>
                    <h6> al gusto Aceite</h6> 
    </div>   
    <hr>
<div class="container-fluid">
<h2>Preparacion</h2>
<ol>
   <li> Ponemos en el sartén aceite y el ajo sazonado en aceite dejamos calentar y ponemos el chorizo a que se fría, luego ponemos los frijoles sin caldo, dejamos que hiervan, los machacamos, en un ladino en el sartén volvemos a poner aceite ya que se caliente revolvemos con los frijoles a integrar bien, los frijoles se despegarán del sartén fácilmente.</li>
    <br>
   <li>Servimos y disfrutamos con totopos y un chiles en escabeche.</li>
...
<br>
    ...
    <div class="container">
      <?php
  include("../comentarios/registrar_17.php");
  ?> 
  <br>
  <div class="container"> 
    <?php
  ...
  ?>
      ...
      <?php
        $sql = "SELECT * from comentarios where clave = 17";
