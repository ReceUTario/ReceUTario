...
<body>    
      ...
      <div class="jumbotron mt-4 marg-1">
                    <hr>
                     <h1 class="text-center roboto">Ensalada de frutas.</h1>
               <hr>
    <div class="container-fluid">
            <div class="container text-center"> 
                <img src="../img/postre1.jpg" alt="Ensalada de frutas"  class="img-fluid border border-prymari" >
            </div>
               <hr>     
    <div class="container-fluid text-center">
        <h2>Ingredientes</h2>
            <h6>1.5 Taza de yogurt natural</h6>
            <h6>0.5 Taza de miel de abeja</h6>
            <h6>3 cucharadas de menta </h6>
            <h6>Azucar mascabado al gusto</h6>
            <h6>Canela al gusto</h6>
            <h6>1 Taza de sandia</h6>
            <h6>1 Taza de melon</h6>
            <h6>1 Piza de kiwi</h6>
            <h6>3 Piezas de higo</h6>
            <h6>Amaranto al gusto</h6>
...
<h2>Preparacion</h2>
<ol>
    <li>Mezcla el yogurt con la miel, la menta, el azucar y canela hasta que este bien integrado.</li>
   <br>
    <li>Sirve en una copas la fruta del modo que desees, espolvorea amaranto y tira encima un poco de la mescla del yogurt.</li>
</ol>
</div>
        <hr>
...
<br>
    ...
    <div class="container">
      <?php
  include("../comentarios/registrar_34.php");
  ?> 
  <br>
  <div class="container"> 
    <?php
  ...
  ?>
      ...
      <?php
        $sql = "SELECT * from comentarios where clave = 34";
