...
<body> 
      ...
      <div class="jumbotron mt-4 marg-1">
                    <hr>
                     <h1 class="text-center roboto">Paleta de mora</h1>
               <hr>
    <div class="container-fluid">
            <div class="container text-center"> 
                  
        <img src="../img/postre4.webp" alt="Paleta de mora" class="img-fluid border border-prymari" >
            </div>
               <hr>
        ...
        <h2>Ingredientes</h2>
           ...
           <h6>* 2 Tazas de mora congeladas</h6>
           <h6>* 1 Lata de leche condensada</h6>
           <h6>* 1/2 Taza de agua</h6>
...
<h2>Preparacion</h2>
<ol>
    <li>Licua la leche condensada con las moras y el agua.</li>
   <br>
   <li>Vierte la mezcla en los vasos, tapa con el papel aluminio y coloca un palito de madera en el centro.</li>
 <br>
 <li>Congela durante 3 horas, desmolda y ofrece.</li>
</ol>
</div>
       <hr>
...
<br>
    ...
    <div class="container">
      <?php
  include("../comentarios/registrar_39.php");
  ?> 
  <br>
  <div class="container"> 
    <?php
  ...
  ?>
      ...
      <?php
        $sql = "SELECT * from comentarios where clave = 39";
