...
<HTML lang = "es-MX" >
<HEAD>
    <title>Postre de limon y arandano</title>
...
<body> 
      ...
      <div class="jumbotron mt-4 marg-1">
                    <hr>
                     <h1 class="text-center roboto">Postre de limon con arandanos.</h1>
               <hr>
    <div class="container-fluid">
            <div class="container text-center"> 
                <img src="../img/postre2.webp" alt="postre de limon con arandanos"  class="img-fluid border border-prymari" >
            </div>
               <hr>
        ...
        <h2>Ingredientes</h2>
           ...
           <h6>* 250 gr.de queso crema</h6>
           <h6>* jugo de 2 limones</h6>
           <h6>* 250 gr. de arandanos</h6>
           <h6>* 4 claras</h6>
           <h6>* 280 gr. de azucar</h6>
...
<h2>Preparacion</h2>
<ol>
    <li>Batir la leche condensada con el queso crema y el jugo de limon.</li>
   <br>
    <li>Hacer el merengue batiendo claras y azucar.</li>
<br>
    <li>Alternar en un vaso de presentacion la preparacion y los arandanos.</li>
<br>
<li>Terminar con un copo de merengue.</li>
...
<br>
    ...
    <div class="container">
      <?php
  include("../comentarios/registrar_43.php");
  ?> 
  <br>
  <div class="container"> 
    <?php
  ...
  ?>
      ...
      <?php
        $sql = "SELECT * from comentarios where clave = 43";
