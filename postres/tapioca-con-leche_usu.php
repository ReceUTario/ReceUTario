...
<div class="text-center">
  ...
  <figcaption class="figure-caption" style="color: black;"> <?php echo "$usuario"; ?></figcaption>
      ...
      <div class="jumbotron mt-4 marg-1">
                    <hr>
                     <h1 class="text-center roboto">Tapioca con leche</h1>
               <hr>
    <div class="container-fluid">
            <div class="container text-center"> 
              <img src="../img/postre12.jpeg" alt="Tapioca con leche"class="img-fluid border border-prymari" >
            </div>
               <hr>
        ...
        <h2>Ingredientes</h2>
           ...
           <h6>* 1 taza de perlas de tapioca</h6>
           <h6>* 1 Litro de leche de coco</h6>
           <h6>* 1 lata de crema de coco</h6>
           <h6>* 1 Taza de cubos de durazno</h6>
           <h6>* Hojas de menta para decorar</h6>
    </div>
  </div>
  <hr>
...
<h2>Preparacion</h2>
<ol>
<li>Calienta la tapioca con la leche y la crema de coco; cuando comience a hervir baja el fuego al minimo y cuece hasta que la tapioca se haya esponjado y este suave.</li>
<br>
<li>Enfria completamente y mezcla con durazno.</li>
<br>
<li>Sirve en vasos individueles y adorna con algunas hojas de menta.</li>
</ol>
</div>
...
<br>
    ...
    <div class="container">
      <?php
  include("../comentarios/registrar_45.php");
  ?> 
  <br>
  <div class="container"> 
    <?php
  ...
  ?>
      ...
      <?php
        $sql = "SELECT * from comentarios where clave = 45";
