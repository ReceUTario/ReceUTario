...
<body>    
      ...
      <div class="jumbotron mt-4 marg-1">
                    <hr>
                     <h1 class="text-center roboto">Agua de horchata.</h1>
               <hr>
    <div class="container-fluid">
            <div class="container text-center"> 
                <img src="../img/agua2.jpg" alt="Agua de jamaica"  class="img-fluid border border-prymari" >
            </div>
               <hr>
        ...
        <h2>Ingredientes</h2>
            ...
            <h6>1 Taza de flor de jamaica</h6>
            <h6>12 Tazas de agua</h6>
            <h6>1/2 taza de azucar o si prefieres puedes agregarle mas</h6> 
            <h6>Usar stevia al gusto</h6>
            <h6>Hielos para servir</h6>
    </div>
    </div>
    <hr>
...
<h2>Preparacion</h2>
<ol>
<li>Coloca 4 tazas de agua en una ollita junto con la flor de jamaica.</li>
<br>
<li>Deja que hierva unos 5 minutos a fuego medio bajo.</li>
<br>
<li>Cuela el agua y reserva las flores.</li>
<br>
<li>Agrega el agua restante, el azucar y mezcla bien.</li>
<br>
<li>Puesdes endulzar a tu gusto si crees que le falta azucar o si te gusta muy dulce el agua.</li>
<br>
<li>Refrijera para servir bien fria o sirvir bien fria o sirve con hielos.</li>
<br>
<li>Si se te hace muy fuerte el sabor agrega mas agua al gusto hasta que este con el sabor que mas te gusto.</li>
<br>
</ol>
</div>
 <hr>
...
<br>
    ...
    <div class="container">
      <?php
  include("../comentarios/registrar_4.php");
  ?> 
  <br>
  <div class="container"> 
    <?php
  ...
  ?>
      ...
      <?php
        $sql = "SELECT * from comentarios where clave = 4";
