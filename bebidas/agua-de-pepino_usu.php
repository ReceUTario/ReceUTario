...
<body> 
      ...
      <div class="jumbotron mt-4 marg-1">
                    <hr>
                     <h1 class="text-center roboto">Agua de pepino.</h1>
               <hr>
    <div class="container-fluid">
            <div class="container text-center"> 
                <img src="../img/agua3.jpg" alt="Agua de pepino" class="img-fluid border border-prymari" >
            </div>
               <hr>
...
<h6>* 3 Litros de agua</h6>
<h6>* 2 a 3 Limones, en rodaja fina</h6>
<h6>* 1 Pepino</h6>
<h6>* 10 a 15 Hojas de menta</h6>
        </div>
    </div>
    <hr>
...
<h2>Preparacion</h2>
<ol>
<li>Lava y seinfecta los limones, los pepino y las hojas de menta.</li>
<br>
<li>Corta los limones y los pepinos en rebanadas muy delgadas, puedes ayudarte con una mandolina.</li>
<br>
<li>Coloca el agua en una jarra grande y agrega todos los ingredientes y deja reposar en refrijeracion por 4 minimo o por toda la noche.</li>
<br>
<li>Toma esta agua al largo de tu dia. </li>
...
<br>
    ...
    <div class="container">
      <?php
  include("../comentarios/registrar_11.php");
  ?> 
  <br>
  <div class="container"> 
    <?php
  ...
  ?>
      ...
      <?php
        $sql = "SELECT * from comentarios where clave = 11";
