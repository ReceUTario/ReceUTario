...
<body> 
      ...
      <div class="jumbotron mt-4 marg-1">
                    <hr>
                     <h1 class="text-center roboto">Agua de melon.</h1>
               <hr>
    <div class="container-fluid">
            <div class="container text-center"> 
<img src="../img/agua12.jpg" alt="Agua de melon" class="img-fluid border border-prymari" >
            </div>
               <hr>
        <div class="container text-center">
        <h2>Ingredientes</h2>
<h6>* 1 Pieza de melon chino</h6>
<h6>* 3 Tazas de agua</h6>
<h6>* 3 Cucharadas de azucar o endulzante</h6>
<h6>* 10 Hojas de menta</h6>
<h6>* Hielo</h6>
</div>
</div>
<hr>        
...
<h2>Preparacion</h2>
<ol>
    <li>Pela el melon y retiras las semillas.</li>
    <br>
    <li>Corta en trozos medianos.</li>
    <br>
    <li>Agrega en la licuadora el melon y azucar o endulzante junto con 1 taza de agua.</li>
    <br>
    <li>Cuando tengas una mezcla homogenea agrega el agua restante y vuelve a licuar.</li>
    <br>
    <li>Agrega hielos y decora con hojas de menta.</li>
</ol>
</div>
<hr>
...
<br>
    ...
    <div class="container">
      <?php
  include("../comentarios/registrar_9.php");
  ?> 
  <br>
  <div class="container"> 
    <?php
  ...
  ?>
      ...
      <?php
        $sql = "SELECT * from comentarios where clave = 9";
