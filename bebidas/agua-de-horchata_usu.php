...
<body> 
    ...
    <div class="container-fluid">
            <div class="container text-center"> 
                <img src="../img/agua1.jpg" alt="Agua de horchata"  class="img-fluid border border-prymari" >
            </div>
               <hr>
        ...
        <h2>Ingredientes</h2>
            <h6>* 240g de arroz</h6>
            <h6>* 3 Varas de canela</h6>
            <h6>* 1 Lata de leche condensada</h6>
            <h6>* 2L de agua</h6>
            <h6>* 1/2 Cucharada de extrato de vainilla</h6>
            <h6>* Azucar al gusto</h6> 
        </div>  
    </div> 
    <hr>
<div class="container-fluid">
<h2>Preparación</h2>
<ol>
<li>Remoja el arroz en un recipiente por media hora.</li>
<br>
<li>Remoja las rajas de canela en otro recipiente durante 15 minutos.</li>
<br>
<li>Escurre el agua de ambos recipientes y licual el arroz, la canela, la leche condensada, azucar si deseas el agua dulce y la escencia de vainilla.</li>
<br>
<li>Cuela la preparacion y sirve con hielos.</li>
<br>
</ol>
</div>
        <hr>
...
<br>
    ...
    <div class="container">
      <?php
  include("../comentarios/registrar_3.php");
  ?> 
  <br>
  <div class="container"> 
    <?php
  ...
  ?>
      ...
      <?php
        $sql = "SELECT * from comentarios where clave = 3";
