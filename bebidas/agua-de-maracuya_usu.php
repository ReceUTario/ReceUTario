...
<body> 
      ...
      <div class="jumbotron mt-4 marg-1">
                    <hr>
                     <h1 class="text-center roboto">Agua de maracuya.</h1>
               <hr>
    <div class="container-fluid">
            <div class="container text-center"> 
                <img src="../img/agua5.jpg" alt="Agua de maracuya"class="img-fluid border border-prymari" >
            </div>
               <hr>
...
<h6>* 1/2kg de maracuya</h6>
<h6>* 5 Litros de agua</h6>
<h6>* 1/4kg de azucar</h6>
</div>
    </div>
  <hr> 
<div class="container-fluid">
<h2>Preparacion</h2>
<ol>
<li>Coloca las maracuyas en una olla grande y cubre con dos litors y medio de agua. Luego pon a hervir a fuego medio aproximadamente una hora. Cuando esten listas apga el fuego y espera a que enfrie un poco.</li>
<br>
<li>Partelas a la mitad. Colocalas en el vaso de la licuadora y cubre hasta la mitad con el agua con la que hirvieron las maracuyas. Licualo con todo.</li>
<br>
<li>Mezcla la pulpa con el agua con la que hirvieron las frutas y un poco de azucar.</li>
...
<br>
    ...
    <div class="container">
      <?php
  include("../comentarios/registrar_8.php");
  ?> 
  <br>
  <div class="container"> 
    <?php
  ...
  ?>
      ...
      <?php
        $sql = "SELECT * from comentarios where clave = 8";
