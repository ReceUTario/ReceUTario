...
<body> 
      ...
      <div class="jumbotron mt-4 marg-1">
                    <hr>
                     <h1 class="text-center roboto">Piña colada.</h1>
               <hr>
    <div class="container-fluid">
            <div class="container text-center"> 

<img src="../img/agua4.jpg" alt="Piña colada" class="img-fluid border border-prymari" >
            </div>
               <hr>
...
<h6>* 3 Tazas de avena</h6>
<h6>* 1 Litro de agua</h6>
<h6>* 2 Tazas de leche de coco</h6>
<h6>* 1 Taza de jugo de piña natural</h6>
<h6>* 6 Rodajas de piña</h6>
<h6>* Hielos al gusto</h6>
...
<h2>Preparacion</h2>
<ol>
<li>Coloca en la licuadora medio litro de agua, la avena y las rodajas de piña licua hasta que todo quede bien incorporado.</li>
<br>
<li>Verte la mezcla de avena en una jarra y adiciona medio litro de agua, la leche, de coco, el jugo de piña, el jugo de naranja, la crema de coco, y los hielos.</li>
<br>
<li>Sirve esta deliciosa agua de avena sabor de piña colocada y disfruta.</li>
...
<br>
    ...
    <div class="container">
      <?php
  include("../comentarios/registrar_15.php");
  ?> 
  <br>
  <div class="container"> 
    <?php
  ...
  ?>
      ...
      <?php
        $sql = "SELECT * from comentarios where clave = 15";
