...
<body> 
      ...
      <div class="jumbotron mt-4 marg-1">
                    <hr>
                     <h1 class="text-center roboto">Agua de sandia.</h1>
               <hr>
    <div class="container-fluid">
            <div class="container text-center"> 
<img src="../Img/agua9.jpg" alt="Agua de sandia" class="img-fluid border border-prymari" >
            </div>
               <hr>
...
<h2>Preparacion</h2>
<ol>
    <li>Quitar la cortesa de la sandia.</li>
    <br>
    <li>Cortar la mitad de la sandia en cubos chicos y reserva.</li>
    <br>
    <li>El resto de la sandia colocalo en un procesador de alimentos, haz un pure; una vez listo pasalo por un colador fino.</li>
    <br>
    <li>Coloca en una jarra el pure con los cubos de sandia y refrigera hasta la hora de servir.</li>
...
<br>
    ...
    <div class="container">
      <?php
  include("../comentarios/registrar_12.php");
  ?> 
  <br>
  <div class="container"> 
    <?php
  ...
  ?>
      ...
      <?php
        $sql = "SELECT * from comentarios where clave = 12";
