...
<body>    
    <div class="container-fluid">
      <div class="jumbotron mt-4 marg-1">
                    <hr>
                     <h1 class="text-center roboto">Agua de limon.</h1>
               <hr>
    <div class="container-fluid">
            <div class="container text-center"> 
                <img src="../img/agua6.jpg" alt="Agua de limon" class="img-fluid border border-prymari" >
            </div>
               <hr>
        ...
        <h2>Ingredientes</h2>
            ...
            <h6>* 3/4 de taza de azucar</h6>
            <h6>* 2 cdas. de ralladura de limon amarillo</h6>
            <h6>* 3 cdas. de jugo de limon amarillo</h6>
            <h6>* 5 cdas. de limon</h6>
            <h6>* 1/2 Taza de jugo de limon verde</h6>
            <h6>* 2 tazas de agua mineral verde</h6>
            <h6>* Cubos de hielo</h6>
            <h6>* Hojas de menta</h6>
...
<h2>Preparacion</h2>
<ol>
<li>En una sarten hierve el azucar con una taza de agua moviendo para que todo se incorpore. Permite enfriar, agrega las ralladuras y los jugos.</li>
<br>
<li>Deja descansar y cuela el jarabe, divide el hielo en 4 vasos, sirve el jarabe y el agua mineral.</li>
<br>
<li>Decora con las hojas de menta.</li>
<br>
...
<br>
    ...
    <div class="container">
      <?php
  include("../comentarios/registrar_6.php");
  ?> 
  <br>
  <div class="container"> 
    <?php
  ...
  ?>
      ...
      <?php
        $sql = "SELECT * from comentarios where clave = 6";
