...
<body> 
      ...
      <div class="jumbotron mt-4 marg-1">
                    <hr>
                     <h1 class="text-center roboto">Agua de tamarindo.</h1>
               <hr>
    <div class="container-fluid">
            <div class="container text-center"> 
<img src="../img/agua15.jpg" alt="agua de tamarindo" class="img-fluid border border-prymari" >
            </div>
               <hr>
        ...
        <h2>Ingredientes</h2>
            ...
            <h6>* 15 tamarindos, seco </h6>
            <h6>* 5 tazas de agua</h6>
                <h6>* 1/4 tazas de azúcar</h6>
                    <h6>* hielos, al gusto</h6>
                        <h6>* chiles piquín molidos, al gusto</h6>
 </div>
</div>
<hr>
...
<h2>Preparacion</h2>
<ol>
    <li>Pela los tamarindos y retírales las semillas.</li>
    <br>
    <li>Calienta el agua, una vez que rompa el punto de hervor, agrega los tamarindos y apaga la preparación. Retírale las semillas a los tamarindos.</li>
        <br>
        <li>Agrega azúcar.</li>
            <br>
            <li>Coloca el agua en la licuadora y bate.</li>
                <br>
                <li>Pasa por un colador la preparación.</li>
                    <br>
                    <li>Agrega hielos y sirve.</li>   
</ol>
</div>
  <hr>
...
<br>
    ...
    <div class="container">
      <?php
  include("../comentarios/registrar_13.php");
  ?> 
  <br>
  <div class="container"> 
    <?php
  ...
  ?>
      ...
      <?php
        $sql = "SELECT * from comentarios where clave = 13";
