...
<body> 
      ...
      <div class="jumbotron mt-4 marg-1">
                    <hr>
                     <h1 class="text-center roboto">Agua de mango.</h1>
               <hr>
    <div class="container-fluid">
            <div class="container text-center"> 
 <img src="../img/agua7.jpg" alt="Agua de mango"  class="img-fluid border border-prymari" >
            </div>
               <hr>
...
<div class="container text-center">
        <h2>Ingredientes</h2>
        <h6>
            <h6>* 2 Cucharadas de azucar</h6>
            <h6>* 1 1/2 litros de agua</h6>
            <h6>* 3 Piwzas de mango</h6>
...
<ol>
    <li>Cortar los mangos.</li>
    <br>
    <li>Extraer la pulpa y colocar en el vaso de la licuadora hasta la mitad del vazo</li>
    <br>
    <li>Agregar azucar y agua hasta cubrir la fruta, licuar.</li>
    <br>
    <li>Regresar el mango molido a la jarra con el resto del agua.</li>
...
<br>
    ...
    <div class="container">
      <?php
  include("../comentarios/registrar_7.php");
  ?> 
  <br>
  <div class="container"> 
    <?php
  ...
  ?>
      ...
      <?php
        $sql = "SELECT * from comentarios where clave = 7";
