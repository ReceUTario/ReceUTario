...
<!-- Carrucel -->
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
        <a href="postres/hot-cakes.php"><img src="Img/carrucel1.png" class="d-block img-fluid" alt="Hot cakes"></a>
...
<!-- Muestras -->
        <div class="container text-center">
         ...
         <!-- -->
               <div class="container text-center ">
                <div class="mues container-fluid">
                    <div>
                        <a href="postres/pastel-de.zanahoria.php"><img src="Img/Postres/pastel_zanahoria.png" alt="Pastel de Zanahoria" class="img-fluid"></a>
                    </div>
                    <div>
                        <br>
                       <p class="text-danger">Postre</p>
                ...
                <div class="mues container-fluid">
                    <div>
                        <a href="postres/postre-de-limon-y-arandano.php"><img src="Img/Postres/limon_arandanos.png" alt="Postre de limon con arandanos" class="img-fluid"></a>
                    </div>
                    <div >
                        <br>
                       <p class="text-danger">Postre</p>
                 ...
                 <div class="mues container-fluid">
                    <div>
                        <a href="postres/gelatina-con-leche-y-fresa.php"><img src="Img/Postres/gelatina_fresas.png" alt="Gelatina de leche con fresas" class="img-fluid"></a>
                    </div>
                    <div>
                        <br>
                       <p class="text-danger">Postre</p>
                   ...
                   <div class="mues container-fluid">
                    <div>
                        <a href="postres/pay-de-queso.php"><img src="Img/Postres/pay_queso.png" alt="Pay de queso" class="img-fluid"></a>
                    </div>
                    <div>
                        <br>
                       <p class="text-danger">Postre</p>
                   ...
                   <div class="mues container-fluid">
                    <div>
                        <a href="postres/paletas-de-mora.php"><img src="Img/Postres/paleta_mora.png" alt="Paleta de mora" class="img-fluid"></a>
                    </div>
                    <div>
                        <br>
                       <p class="text-danger">Postre</p>
        ...
        <!-- -->
                ...
                <div class="mues container-fluid">
                    <div>
                        <a href="postres/Musse-de-mango.php"><img src="Img/Postres/mus_mango.png" alt="Mus de mango" class="img-fluid"></a>
                    </div>
                    <div>
                       <br>
                       <p class="text-danger">Postre</p>
                ...
                <div class="mues container-fluid">
                    <div>
                        <a href="postres/postre-frie-de-pi%C3%B1a.php"><img src="Img/Postres/pastel_pi%C3%B1a.png" alt="Pastel de piña" class="img-fluid"></a>
                    </div>
                    <div>
                        <br>
                       <p class="text-danger">Postre</p>
                 ...
                 <div class="mues container-fluid">
                    <div>
                        <a href="postres/brownies.php"><img src="Img/Postres/brownies.png" alt="Brownies" class="img-fluid"></a>
                    </div>
                    <div>
                        <br>
                       <p class="text-danger">Postre</p>
                   ...
                   <div class="mues container-fluid">
                    <div>
                        <a href="postres/cheesecake.php"><img src="Img/Postres/chessecake.png" alt="Cheesecake" class="img-fluid"></a>
                    </div>
                    <div>
                        <br>
                       <p class="text-danger">Postre</p>
                   ...
                   <div class="mues container-fluid">
                    <div>
                        <a href="postres/hot-cakes.php"><img src="Img/Postres/hotcakes.png" alt="HotCakes" class="img-fluid"></a>
                    </div>
                    <div>
                        <br>
                       <p class="text-danger">Postre</p>
